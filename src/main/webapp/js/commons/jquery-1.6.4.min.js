        ...
        if (!supportsInputPlaceholder()) {
            this.each(function () {
                ...
                if (isInputBox) { //如果是密码或文本输入框
                    ...
                    if (thisEle.val() == "") {
                        thisEle.css("color", _plaColor);//解决ie下刷新无法清空已输入input数据问题
...
$.extend({
    ...
    inputIsEmpty: function (_id) {
        ...
        var value = $("#" + _id).val();
        if (!supportsInputPlaceholder()) {
            var placeholder = $("#" + _id).attr("placeholder");
            if ($.trim(value) == "" || value == placeholder) {
                return true;
            }
        } else if ($.trim(value) == "") {
            return true;
